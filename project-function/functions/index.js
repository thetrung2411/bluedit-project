...
const {signup, login, getCurrentUser, changeUserDetail, deleteUser} = require("./handlers/users");
...
app.get("/user", FBAuth, getCurrentUser, deleteUser);
app.post("/editProfile", changeUserDetail);
